 ...
 *
 */
void motorControl_spin4Steps()
{
    motorControl_spinMotor(connectedMotors[1], 5, 3, 0, 10);
}
void motorControlSens_spin4Steps()
{
    motorControl_spinMotor(connectedMotors[0], 200, 3, 1, 10);
}